          ...
          <div className="lg:col-span-4 flex flex-col">
            <div className="border border-muted bg-card h-full flex flex-col">
              ...
              <div className="p-6 md:p-8 border-t border-muted bg-muted/10">
                <a href="mailto:sq103832@outlook.com" className="w-full inline-flex items-center justify-between border border-primary bg-primary text-primary-foreground hover:bg-background hover:text-primary px-6 py-4 font-bold uppercase tracking-widest transition-all">
                  {contact.getInTouch}
