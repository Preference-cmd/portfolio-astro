...
const badgeVariants = cva(
  "inline-flex items-center border border-muted px-3 py-1 text-xs font-mono uppercase tracking-widest font-bold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
